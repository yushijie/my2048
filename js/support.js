...
function get_number_fontsize(number) {
	if (number < 128){
		...
		return 0.5 * cell_side_length + 'px';
	}else if(number >=1024 && number < 16384){
		return 0.4 * cell_side_length + 'px';
	}else if(number >=16384 && number < 131072){
		return 0.3 * cell_side_length + 'px';
	}else {
		return 0.2 * cell_side_length + 'px';
	}
}
